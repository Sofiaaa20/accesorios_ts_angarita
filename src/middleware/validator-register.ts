...
const validatorParams = [
  check('documento').isLength({ min: 8, max: 15 }).withMessage('El documento debe de ser de 10 caracteres'),
  ...
  check('direccion').isLength({ min: 8, max: 15 }).withMessage('La direccion es de 10 caracteres'),
